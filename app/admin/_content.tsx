          ...
          <div className="relative border border-neutral-850 bg-neutral-900 backdrop-blur-xl p-8 rounded-2xl w-full max-w-4xl max-h-[85vh] overflow-y-auto shadow-2xl shadow-neutral-950/50">
            ...
            <form onSubmit={handlePerformerSubmit} className="space-y-6">
              ...
              <div className="flex gap-4 pt-4 border-t border-neutral-850">
                <button
                  type="submit"
                  className="flex-1 py-3.5 bg-gradient-to-r from-pink-600 to-purple-600 text-white rounded-xl text-sm font-bold uppercase tracking-wider hover:scale-[1.01] active:scale-[0.99] transition-all shadow-lg shadow-pink-500/10"
                >
                ...
                <button
                  type="button"
                  onClick={() => setIsPerformerModalOpen(false)}
                  className="px-8 py-3.5 bg-neutral-800 border border-neutral-700 text-neutral-300 rounded-xl text-sm font-bold uppercase tracking-wider hover:bg-neutral-700 transition-all"
                >
                  Cancel
                </button>
              </div>
