...
export default function GirlProfileContent() {
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
      ...
      <div className="flex flex-col lg:flex-row gap-5 lg:gap-6">
        ...
        <main className="flex-1 min-w-0">
          ...
          {/* Specialties */}
          <aside className="flex flex-wrap gap-1.5 mb-3" aria-label="Specialties">
          ...
          {/* ── CHAT ── */}
          <section className="rounded-xl overflow-hidden" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }} aria-label="Chat">
        ...
        <aside className="w-full lg:w-72 xl:w-80 shrink-0" aria-label="Performer Collection">
          {/* Profile card */}
